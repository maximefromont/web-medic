...
$sql = "INSERT INTO patient (name, firstname, gender, birthdate, adresse, housephone, prophone, cellphone, mail, sentby, nummut, job, situation, childrens, note, id_medecin, id_mutuelle, id_user) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
$stmt = $db->prepare($sql);
...
$stmt->execute([
    $name, $firstname, $gender, $birthdate, $adresse, $_housephone, $prophone, $cellphone, $mail, $sentby, $nummut, $job, $situation, $childrens, $note, $id_medecin, $id_mutuelle, $id_user
]);
